...
export const UUID_VERSION_METADATA: Record<UUIDVersion, UUIDVersionMetadata> = {
  v4: {
    version: 'v4',
    name: 'Random',
    description: 'Generates a completely random UUID using cryptographic random number generation. Most common and simple to use.',
    features: [
  ...
  v7: {
    ...
    description: 'Modern UUID with Unix timestamp embedded. Sortable by creation time and optimized for database indexes.',
    features: [
  ...
  v1: {
    ...
    description: 'Classic time-based UUID with timestamp and random node ID. Older standard but still widely supported.',
    features: [
      'Contains timestamp',
      'Sortable by time',
  ...
  v5: {
    version: 'v5',
    name: 'Name-based',
    description: 'Deterministic UUID generated from a namespace and name. Same input always produces the same UUID.',
    features: [
