  ...
  useCases: [
    {
      ...
      description:
        'Format and validate API responses and request payloads during development and debugging.',
    },
    {
      title: 'Configuration Files',
      description:
        'Pretty-print configuration files for better readability and easier maintenance.',
    },
    {
    ...
    },
    {
      title: 'Minification',
      description:
        'Reduce file size by removing unnecessary whitespace for production deployments.',
    },
    {
      title: 'Data Transformation',
      description:
        'Sort object keys alphabetically for consistent data structure and easier comparison.',
    },
  ],
