      ...
      <ScrollView style={{ flex: 1 }}>
        <View style={{ padding: spacing.l }}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.unitButtons}>
              ...
              >
                ...
                <Text style={[styles.unitButtonText, { color: unit === 'words' ? '#fff' : colors.text }]}>
                  Words
                </Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={[styles.unitButtonText, { color: unit === 'sentences' ? '#fff' : colors.text }]}>
                  Sentences
                </Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={[styles.unitButtonText, { color: unit === 'paragraphs' ? '#fff' : colors.text }]}>
                  Paragraphs
                </Text>
              </TouchableOpacity>
            </View>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={[styles.checkbox, { borderColor: colors.border, backgroundColor: startWithLorem ? colors.primary : 'transparent' }]}>
            ...
            {unit === 'paragraphs' && (
              ...
              >
                <View style={[styles.checkbox, { borderColor: colors.border, backgroundColor: htmlParagraphs ? colors.primary : 'transparent' }]}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.stats}>
              <View style={[styles.statCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <Text style={[styles.statValue, { color: colors.primary }]}>{result.wordCount}</Text>
                <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Words</Text>
              </View>
              <View style={[styles.statCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <Text style={[styles.statValue, { color: colors.primary }]}>{result.charCount}</Text>
                <Text style={[styles.statLabel, { color: colors.textSecondary }]}>Characters</Text>
              </View>
              <View style={[styles.statCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <Text style={[styles.statValue, { color: colors.primary }]}>{result.paragraphCount}</Text>
          ...
          <View style={[styles.infoCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
            ...
            <View style={styles.infoTextContainer}>
              ...
              <Text style={[styles.infoText, { color: colors.textSecondary }]}>
                Placeholder text used in design mockups since the 1500s. Tap the info button above to learn more.
              </Text>
            </View>
          </View>
        </View>
