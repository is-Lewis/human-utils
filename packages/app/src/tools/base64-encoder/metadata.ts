...
export const BASE64_INFO = {
  title: 'About Base64',
  description: 'Base64 is a binary-to-text encoding scheme that represents binary data in ASCII string format. It\'s commonly used for encoding data in emails, URLs, and data URIs.',
  useCases: [
    {
      title: 'Data URIs',
